...
void Read_PYTHIA_hists(const int energy = 510)
{
  ...
  if(energy == 510)
  {
    inFile = new TFile("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Simulation/PYTHIA/input/Run17/output_Lambda_pp_510_MB_200M_events.root", "READ");
  ...
  if(energy == 200) inFile = new TFile("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Simulation/PYTHIA/input/Run12/output_Lambda_pp_200_MB_10M_events_new.root", "READ");
